...
//    @DeleteMapping("/admin")
//    public ResponseEntity delete(@RequestBody Admin admin) throws NoSuchAlgorithmException{
...
//        }else{
//            return new ResponseEntity(DefaultRes.res(StatusCode.OK, "[SUCCESS]deleteAdmin", admin), HttpStatus.OK);
//        }
//    }
