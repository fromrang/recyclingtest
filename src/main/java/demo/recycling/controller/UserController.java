...
public class UserController {
    ...
    public String kakaoCallback() {
        return "kauth.kakao.com/oauth/authorize?client_id=4e2b5b43114dc36b9d0fdac9b15fb983&redirect_uri=http://localhost:7878/oauth/kakao/callback&response_type=code";
    }
