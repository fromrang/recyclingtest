...
public interface RoomMapper {
    ...
    // Tag
    @Select("select r.rum,r.title,r.count,r.maxnum, r.rm_type ,r.reg_date,t.tag_name as tag from room r inner join tag t on r.rum=t.rum")
    public List<Room> selectTagList() throws Exception;
    // Title
    @Select("select r.rum,r.title,r.count,r.maxnum,r.rm_type,r.reg_date,t.tag_name as tag from room r inner join tag t on r.rum=t.rum where r.title like CONCAT('%',#{keyword},'%')")
